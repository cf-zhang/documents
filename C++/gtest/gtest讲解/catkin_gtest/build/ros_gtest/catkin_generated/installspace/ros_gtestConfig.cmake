...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ros_gtest' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cfzhang/xcode/catkin_gtest/install/${idir}'.  Ask the maintainer 'cfzhang <cfzhang@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/cfzhang/xcode/catkin_gtest/install/lib;/home/cfzhang/xcode/catkin_gtest/devel/lib;/home/cfzhang/opensource/catkin_open/devel/lib;/home/cfzhang/opensource/ros_gtest_example/devel/lib;/home/cfzhang/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
